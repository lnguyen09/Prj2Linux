#The python file to perform Machine Learning model training from input text to predict stress or no stress
...
#Get the text input from the user, analyze and return the result
try:
    ...
    #Return the result
    record = {"Input":text, "Result": output[0]}
